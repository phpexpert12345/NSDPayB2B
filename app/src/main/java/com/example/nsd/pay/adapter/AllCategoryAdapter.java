...
public class AllCategoryAdapter extends RecyclerView.Adapter<AllCategoryAdapter.ViewHolder> {
    ...
    public AllCategoryAdapter(Context context, List<AllListData> modelArrayList, AllCategoryInterface allCategoryInterface) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.layout_category_items, parent, false);
