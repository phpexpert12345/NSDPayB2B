...
public class OtherBankAdapter extends RecyclerView.Adapter<OtherBankAdapter.ViewHolder> {
    ...
    public OtherBankAdapter(Context context, Activity activity, List<String> modelArrayList) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.layout_other_banks, parent, false);
